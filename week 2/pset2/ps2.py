...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        if width <= 0 or height <= 0:
            raise ValueError('width/height should be > 0 !')
        self.width = width
        self.height = height
        # build a width*height matrix
        self.tiles = [[False for x in range(height)] for y in range(width)]
    ...
    def getNumCleanedTiles(self):
        ...
        """
        total = 0
        for ix_row in range(self.height):
            for ix_col in range(self.width):
                if self.tiles[ix_col][ix_row] is True:
                    total += 1
        return total
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.room = room
        if speed <= 0:
            raise ValueError("Speed should be > 0 !!!")
        self.speed = speed
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        been cleaned.
        """
        new_p = self.position.getNewPosition(self.getRobotDirection(), self.speed)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    #anim.done()
    return time_step / num_trials


# Uncomment this line to see how much your simulation takes on average
#print(runSimulation(2, 1, 8, 8, 0.8, 30, StandardRobot))
